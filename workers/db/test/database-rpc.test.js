    ...
    describe('ai-database CRUD operations', () => {
        describe('get()', () => {
            ...
            it('should support type inference for returned document', async () => {
                ...
                const user = await instance.get('users', '123');
        ...
        describe('list()', () => {
            it('should return empty array for empty collection', async () => {
                const instance = new DatabaseDO(ctx, env);
                const result = await instance.list('empty_collection');
            ...
            it('should list all documents in collection', async () => {
                ...
                const result = await instance.list('users');
            ...
            it('should respect limit option', async () => {
                ...
                const result = await instance.list('users', { limit: 2 });
            ...
            it('should respect offset option', async () => {
                ...
                const result = await instance.list('users', { offset: 2, limit: 10 });
            ...
            it('should support orderBy option', async () => {
                ...
                const result = await instance.list('users', { orderBy: 'name', order: 'asc' });
            ...
            it('should support where clause filtering', async () => {
                ...
                const result = await instance.list('users', { where: { active: true } });
        ...
        describe('create()', () => {
            ...
            it('should store document in correct collection', async () => {
                ...
                const retrieved = await instance.get('users', 'test-id');
        ...
        describe('update()', () => {
            ...
            it('should not allow changing _id', async () => {
                ...
                const updated = await instance.update('users', '123', { _id: 'new-id', name: 'Harry' });
    ...
    describe('HTTP fetch() handler', () => {
        ...
        describe('HATEOAS discovery', () => {
            ...
            it('should include available collections in discovery', async () => {
                ...
                const response = await instance.fetch(request);
                const data = await response.json();
                const collectionNames = data.discover.collections.map((c) => c.name);
