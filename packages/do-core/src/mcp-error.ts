...
export class McpError extends Error {
   ...
   * @param data - Optional additional error data
   */
  static parseError(message = 'Parse error', data?: unknown): McpError {
   ...
   * @param data - Optional additional error data
   */
  static invalidRequest(message = 'Invalid Request', data?: unknown): McpError {
   ...
   * @param data - Optional additional error data
   */
  static methodNotFound(methodName?: string, data?: unknown): McpError {
   ...
   * @param data - Optional additional error data
   */
  static invalidParams(message = 'Invalid params', data?: unknown): McpError {
   ...
   */
  static fromError(error: Error, code = McpErrorCode.InternalError): McpError {
 ...
 */
export function getDefaultMessage(code: McpErrorCode): string {
  switch (code) {
