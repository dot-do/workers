...
import { GracefulShutdown, ShutdownState, } from '../src/index';
describe('GracefulShutdown', () => {
    ...
    describe('Cleanup Hooks', () => {
        ...
        it('should respect cleanup hook timeout', async () => {
            const slowCleanup = vi.fn().mockImplementation(() => new Promise((resolve) => setTimeout(resolve, 5000)));
    ...
    describe('WebSocket Connection Management', () => {
        it('should track WebSocket connections', () => {
            ...
            shutdown.trackWebSocket('ws-1', mockWs);
        ...
        it('should handle multiple WebSocket connections', async () => {
            ...
            shutdown.trackWebSocket('ws-1', mockWs1);
            shutdown.trackWebSocket('ws-2', mockWs2);
            await shutdown.initiateShutdown();
    ...
    describe('Event Emission', () => {
        it('should emit shutdown initiated event', async () => {
            ...
            await shutdown.initiateShutdown();
            expect(listener).toHaveBeenCalledWith(expect.objectContaining({ type: 'shutdown:initiated' }));
        });
        ...
        it('should emit complete event', async () => {
            ...
            await shutdown.initiateShutdown();
            expect(listener).toHaveBeenCalledWith(expect.objectContaining({ type: 'shutdown:complete' }));
        });
    ...
    describe('Request Context Wrapper', () => {
        ...
        it('should track request even if handler throws', async () => {
            ...
            const wrappedHandler = shutdown.wrapHandler(handler);
            await expect(wrappedHandler(new Request('https://example.com'))).rejects.toThrow('Handler error');
