...
describe('HumansDO Response Handling', () => {
    ...
    describe('respondToTask()', () => {
        ...
        it('should throw error if task already completed', async () => {
            ...
            await expect(instance.respondToTask(created._id, {
                decision: 'reject',
    ...
    describe('decide()', () => {
        ...
        it('should store decision with rationale', async () => {
            ...
            const decided = await instance.decide(created._id, 'canary', 'Lower risk for this release', 'architect@example.com');
