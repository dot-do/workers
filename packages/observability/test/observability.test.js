...
import { Metrics, Tracer, createObservabilityHooks, Timer, PrometheusExporter, WorkerIntegration, } from '../src/index';
describe('Metrics', () => {
    let metrics;
    beforeEach(() => {
        metrics = new Metrics();
...
describe('Type exports', () => {
    it('should export all required types', () => {
        ...
        const _tags = { key: 'value' };
        const _metricValue = { value: 1, tags: _tags };
        const _counter = { type: 'counter', name: 'test', values: [] };
        const _gauge = { type: 'gauge', name: 'test', values: [] };
        const _histogram = {
            type: 'histogram',
            name: 'test',
            values: [],
        ...
        const _spanOptions = { parent: undefined };
        const _spanContext = { traceId: 'abc', spanId: '123' };
        const _config = {};
