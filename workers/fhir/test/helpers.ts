/**
 * Test helpers for FHIR worker tests
 *
 * Provides mock implementations for FHIR DO testing.
 */
...
/**
 * Mock DOStorage interface for FHIR
 */
...
/**
 * Mock environment bindings for FHIR
 */
export interface MockFHIREnv {
  FHIR_DO?: {
 ...
 */
export function createMockEnv(): MockFHIREnv {
  return {
    FHIR_DO: {
      get: vi.fn(),
