...
import { AuthContext, createRBAC, checkPermission, hasRole, hasPermission, requirePermissions, requireRole, PermissionDeniedError, } from '../src/index.js';
    ...
    describe('requirePermissions decorator/guard', () => {
        ...
        it('should include missing permissions in error', async () => {
            ...
            try {
                ...
                expect(error.missingPermissions).toContain('delete');
                expect(error.missingPermissions).toContain('admin');
            }
        });
    });
