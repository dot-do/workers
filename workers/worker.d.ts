/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker.d.ts` (hash: 09cec36ce56e0f50fd1b6770beb085c9)
// Runtime types generated with workerd@1.20250705.0 2025-01-08 
declare namespace Cloudflare {
	interface Env {
		db: Fetcher /* db */;
		yaml: Fetcher /* yaml */;
		do: DispatchNamespace;
		ASSETS: Fetcher;
