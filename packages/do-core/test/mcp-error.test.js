...
import { McpError, McpErrorCode, isMcpError, isMcpErrorCode, getDefaultMessage, } from '../src/mcp-error.js';
describe('McpError', () => {
    ...
    describe('isMcpError() type guard', () => {
        ...
        it('should narrow type correctly', () => {
            const error = new McpError(McpErrorCode.ParseError, 'Test');
            if (isMcpError(error)) {
    ...
    describe('getDefaultMessage()', () => {
        ...
        it('should return Unknown error for invalid codes', () => {
            ...
            expect(getDefaultMessage(-99999)).toBe('Unknown error');
        });
    });
