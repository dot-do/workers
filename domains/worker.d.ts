/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker.d.ts` (hash: 3301c18a2eab585b98c13828d7c03501)
// Runtime types generated with workerd@1.20250705.0 2025-07-08 
declare namespace Cloudflare {
	interface Env {
		DYNADOT_KEY: string;
		DYNADOT_SECRET: string;
		DYNADOT_SANDBOX_KEY: string;
		DYNADOT_SANDBOX_SECRET: string;
