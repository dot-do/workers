...
describe('CDC Event Batching', () => {
    ...
    describe('Batch Size Limits', () => {
        ...
        it('should respect maxBytes limit', async () => {
            ...
            const largeEvents = Array.from({ length: 10 }, (_, i) => createSampleEvent({
                source: 'test-source',
    ...
    describe('Concurrent Batching', () => {
        it('should handle concurrent event ingestion', async () => {
            ...
            const ingestions = Array.from({ length: 10 }, () => instance.ingestEvent('concurrent', createSampleEvent({ source: 'test-source' })));
        ...
        it('should maintain correct sequence numbers under concurrency', async () => {
            ...
            const ingestions = Array.from({ length: 20 }, () => instance.ingestEvent('seq-concurrent', createSampleEvent({ source: 'test-source' })));
    ...
    describe('Backpressure Handling', () => {
        it('should apply backpressure when buffer is full', async () => {
            ...
            const largeEvents = Array.from({ length: 50 }, () => createSampleEvent({
                source: 'test-source',
