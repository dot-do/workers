...
import { createExecutor, type CodeExecutor } from '../src/index.js'
...
describe('Sandbox Security - Global Scope Isolation', () => {
  ...
  describe('Host global access prevention', () => {
    it('should not access the real globalThis object', async () => {
      ...
      ;(globalThis as any).__SECURITY_TEST_MARKER__ = 'LEAKED'

      const result = await executor.execute(`
        return typeof globalThis.__SECURITY_TEST_MARKER__
      `)

      delete (globalThis as any).__SECURITY_TEST_MARKER__
    ...
    it('should not allow writing to real globalThis', async () => {
      ...
      expect((globalThis as any).__SANDBOX_ESCAPE__).toBeUndefined()
    })
    ...
    it('should not access self object beyond sandbox', async () => {
      ...
      expect((globalThis as any).__ESCAPE__).toBeUndefined()
    })
...
describe('Sandbox Security - Prototype Chain Protection', () => {
  ...
  describe('Built-in prototype modification prevention', () => {
    ...
    it('should not allow modifying Object.prototype', async () => {
      ...
      // Check and clean up
      const wasModified = ({} as any).maliciousMethod !== undefined
      if (wasModified) {
        delete (Object.prototype as any).maliciousMethod
      }
    ...
    it('should not allow using __proto__ to escape', async () => {
      ...
      // Check and clean up
      const wasModified = ({} as any).protoEscapeTest !== undefined
      if (wasModified) {
        delete (Object.prototype as any).protoEscapeTest
      }
    ...
    it('should not allow Object.setPrototypeOf to modify host objects', async () => {
      ...
      // Check and clean up
      const wasModified = (Array.prototype as any).setProtoTest !== undefined
      if (wasModified) {
        delete (Array.prototype as any).setProtoTest
      }
    ...
    it('should not allow Reflect.setPrototypeOf attacks', async () => {
      ...
      const wasModified = ({} as any).reflectTest !== undefined
      if (wasModified) {
  ...
  describe('Prototype pollution via JSON', () => {
    it('should prevent __proto__ pollution via JSON.parse', async () => {
      ...
      // Check and clean up
      const wasModified = ({} as any).jsonProtoTest !== undefined
      if (wasModified) {
        delete (Object.prototype as any).jsonProtoTest
      }
    ...
    it('should prevent constructor pollution', async () => {
      ...
      // Check and clean up
      const wasModified = ({} as any).constructorPollutionTest !== undefined
      if (wasModified) {
        delete (Object.prototype as any).constructorPollutionTest
      }
...
describe('Sandbox Security - Context Injection Safety', () => {
  ...
  describe('Safe context handling', () => {
    it('should not allow context functions to escape sandbox', async () => {
      let escaped = false
      const trapFunction = function(this: any) {
